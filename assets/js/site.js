(() => {
  ...
  const translations = {
    en: {
      ...
      articleTechnology: 'Article · Technology', welcomeTitle: 'Welcome to the archive', welcomeDesc: 'Why this space exists and how the content is organized.', footer: 'Ideas worth sharing.', allTopics: '← All topics', topic: 'Topic', allTags: '← All tags', tag: 'Tag', noArticles: 'No published articles yet. This topic is ready for the first one.',
      exploreDesc: 'Browse ideas and stories by subject. The taxonomy is intentionally open-ended, so new subjects can be added without changing the site\'s runtime.', tagsDesc: 'Small labels for connecting related ideas across topics.', writing: 'Writing', articlesDesc: 'Knowledge, observations, guides and ideas worth keeping.', archiveEyebrow: 'Chronological', archiveDesc: 'A simple timeline of published work, ordered from newest to oldest.', publishedArticles: 'Published articles',
    ...
    vi: {
      ...
      articleTechnology: 'Bài viết · Công nghệ', welcomeTitle: 'Chào mừng đến với kho lưu trữ', welcomeDesc: 'Lý do không gian này tồn tại và cách nội dung được tổ chức.', footer: 'Những điều đáng chia sẻ.', allTopics: '← Tất cả chủ đề', topic: 'Chủ đề', allTags: '← Tất cả thẻ', tag: 'Thẻ', noArticles: 'Chưa có bài viết nào được xuất bản. Chủ đề này đã sẵn sàng cho bài viết đầu tiên.',
      exploreDesc: 'Khám phá ý tưởng và câu chuyện theo chủ đề. Hệ thống phân loại được thiết kế mở để có thể thêm chủ đề mới mà không cần thay đổi phần runtime của website.', tagsDesc: 'Các nhãn nhỏ giúp kết nối những ý tưởng liên quan giữa các chủ đề.', writing: 'Bài viết', articlesDesc: 'Kiến thức, quan sát, hướng dẫn và những ý tưởng đáng lưu giữ.', archiveEyebrow: 'Theo thời gian', archiveDesc: 'Dòng thời gian đơn giản của các nội dung đã xuất bản, từ mới nhất đến cũ nhất.', publishedArticles: 'Bài viết đã xuất bản',
