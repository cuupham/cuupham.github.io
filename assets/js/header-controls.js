(() => {
  ...
  const ICONS = Object.freeze({
    language: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3c2.21 2.28 3.5 5.38 3.5 9s-1.29 6.72-3.5 9c-2.21-2.28-3.5-5.38-3.5-9S9.79 5.28 12 3Z"/></svg>',
