(() => {
  ...
  const ICONS = Object.freeze({
    language: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3c2.4 2.4 3.6 9 0 9s-2.4 6.6-3.6 9s-3.6-5.4-3.6-9S9.6 5.4 12 3Z"/></svg>',
